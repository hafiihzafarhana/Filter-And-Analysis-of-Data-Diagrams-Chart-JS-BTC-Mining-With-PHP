        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse show dropdown-nav">
              <li>
                <a href="chart1.php" class="active"> Tanggal & Level </a>
              </li>
              <li>
...
<?php 
  for ($i=0; $i < 24; $i++) { ?>
    lineChart(<?php echo json_encode($arrNamePHP[$i]) ?>,"myChart"+<?php echo $i+1 ?>, <?php echo json_encode(arrBanyak($arrNamePHP[$i]))?>);
  <?php } ?>
</script>
