        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse show dropdown-nav">
              ...
              <li>
                <a href="chart3.php" class="active"> Tanggal & Level & Jenis (Crash) </a>
              </li>
              <li>
...
<?php 
  for ($i=0; $i < 24; $i++) { ?>
    lineChart(<?php echo json_encode($arrNamePHP[$i]) ?>,"myChart"+<?php echo $i+1 ?>, <?php echo json_encode(arrUntukChart1_2($arrNamePHP[$i],"crash"))?>);
  <?php } ?>
